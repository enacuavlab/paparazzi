...
extern float indi_pend_gain_att;
extern float indi_pend_gain_rate;
...
extern void stabilization_indi_rate_run(bool in_flight, struct StabilizationSetpoint *rate_sp, struct ThrustSetpoint *thrust, int32_t *cmd, float rate_pend_sp);
