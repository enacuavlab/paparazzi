...
/**
 * @file modules/guidance/gvf_parametric/trajectories/gvf_parametric_3d_log_lissajou.h
 *
...
#ifndef GVF_PARAMETRIC_3D_LOG_LISSAJOU_H
#define GVF_PARAMETRIC_3D_LOG_LISSAJOU_H

#ifdef __cplusplus
extern "C" {
#endif

/** @typedef gvf_par_3d_log_lissajou_par
...
typedef struct {
  ...
  float f_z;
  float phi_z;
} gvf_par_3d_log_lissajou_par;

extern gvf_par_3d_log_lissajou_par gvf_parametric_3d_log_lissajou_par;

extern void gvf_parametric_3d_log_lissajou_info(float *f1, float *f2, float *f3, float *f1d, float *f2d, float *f3d,
...
#endif // GVF_PARAMETRIC_3D_LOG_LISSAJOU_H
