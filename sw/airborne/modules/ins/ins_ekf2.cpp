...
# if defined(CONFIG_EKF2_BARO_COMPENSATION)
   ekf_params->max_correction_airspeed = 20.0;
   ekf_params->static_pressure_coef_xp = 1.0;
   ekf_params->static_pressure_coef_xn = 0.0;
   ekf_params->static_pressure_coef_yp = 0.0;
   ekf_params->static_pressure_coef_yn = 0.0;
   ekf_params->static_pressure_coef_z = 0.0;
# endif // CONFIG_EKF2_BARO_COMPENSATION
  ...
  ekf_params->terrain_fusion_mode = 0;
...
# if defined(CONFIG_EKF2_RANGE_FINDER)
 ...
 ekf_params->ev_pos_body = {0.0, 0.0, 0.0};
