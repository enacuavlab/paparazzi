...
#endif
  fprintf(file, "actuators_pprz0,actuators_pprz1,actuators_pprz2,actuators_pprz3,actuators_pprz4,actuators_pprz5,actuators_pprz6,actuators_pprz7\n");
}
...
#endif
  fprintf(file, "%d,%d,%d,%d,%d,%d,%d,%d\n", actuators_pprz[0], actuators_pprz[1], actuators_pprz[2], actuators_pprz[3],  actuators_pprz[4], actuators_pprz[5],  actuators_pprz[6], actuators_pprz[7]);
}
