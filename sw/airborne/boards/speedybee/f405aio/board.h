...
#define BOARD_NAME                  "SPEEDYBE F405 AIO"
 ...
 */
#define	LINE_MOTOR_2                   PAL_LINE(GPIOA, 0U)
#define	LINE_MOTOR_1                   PAL_LINE(GPIOA, 1U)
#define	LINE_MOTOR_3                   PAL_LINE(GPIOA, 2U)
#define	LINE_MOTOR_4                   PAL_LINE(GPIOA, 3U)
...
#define	LINE_OSD_CS                    PAL_LINE(GPIOD, 5U)
#define	LINE_RC1                       PAL_LINE(GPIOD, 6U)
#define	LINE_LED1                      PAL_LINE(GPIOD, 7U)
#define	LINE_UART3_TX                  PAL_LINE(GPIOD, 8U)
#define	LINE_UART3_RX                  PAL_LINE(GPIOD, 9U)
#define	LINE_BEEPER                    PAL_LINE(GPIOD, 11U)
#define	LINE_CAM_PIN                   PAL_LINE(GPIOD, 15U)

#define	LINE_GYRO_EXTI_1               PAL_LINE(GPIOE, 9U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(MOTOR_2) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(MOTOR_2) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(MOTOR_2) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(MOTOR_2) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_LOW(MOTOR_2) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(MOTOR_2, 1) | \
					 PIN_AFIO_AF(MOTOR_1, 1) | \
					 PIN_AFIO_AF(MOTOR_3, 1) | \
					 PIN_AFIO_AF(MOTOR_4, 1) | \
...
#define AF_MOTOR_2                       1U
#define AF_LINE_MOTOR_2                  1U
#define AF_MOTOR_1                       1U
#define AF_LINE_MOTOR_1                  1U
#define AF_MOTOR_3                       1U
#define AF_LINE_MOTOR_3                  1U
#define AF_MOTOR_4                       1U
#define AF_LINE_MOTOR_4                  1U
...
#define MOTOR_2_TIM	 2
#define MOTOR_2_TIM_FN	 CH
#define MOTOR_2_TIM_CH	 1
#define MOTOR_2_TIM_AF	 1
#define MOTOR_1_TIM	 2
#define MOTOR_1_TIM_FN	 CH
#define MOTOR_1_TIM_CH	 2
#define MOTOR_1_TIM_AF	 1
#define MOTOR_3_TIM	 2
#define MOTOR_3_TIM_FN	 CH
#define MOTOR_3_TIM_CH	 3
#define MOTOR_3_TIM_AF	 1
#define MOTOR_4_TIM	 2
#define MOTOR_4_TIM_FN	 CH
#define MOTOR_4_TIM_CH	 4
#define MOTOR_4_TIM_AF	 1
