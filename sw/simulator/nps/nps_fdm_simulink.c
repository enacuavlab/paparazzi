...
static void fetch_accel() {
  ...
  fdm.body_ecef_accel.x = rtY.accel[0]; 
  fdm.body_ecef_accel.y = rtY.accel[1]; 
  fdm.body_ecef_accel.z = rtY.accel[2]; 
...
static void fetch_orient() {
  QUAT_ASSIGN(fdm.ltpprz_to_body_quat, rtY.q[0], rtY.q[1], rtY.q[2], rtY.q[3]);
