...
class MissionManager():
    ...
    def start_mission(self):
        ...
        print("start_mission called") #todo
...
#     LANDPAD = (43.563387, 1.484487)

#     P1 = (43.563553, 1.484010)
#     P2 = (43.563264, 1.484298)
#     P3 = (43.563481, 1.484707)
#     P4 = (43.563751, 1.484427)

#     try:
#         mission = MissionManager(verbose=True)
#         print("cohoma_bridge test started")
#         mission.wait_ready()
#         #mission.add_mission_circle(5, lat=43.563387, lon=1.484487, alt=147, radius=-0.5, duration=20)
#         mission.add_mission_path(1, path=[LANDPAD, P2], alt=147)
#         #mission.add_mission_point(3, lat=43.563469, lon=1.484697, alt=147)
#         mission.add_mission_path(4, path=[P1,P2,P3,P4,P1], alt=147)
#         #mission.add_mission_path(2, path=[P2, LANDPAD] , alt=147)
